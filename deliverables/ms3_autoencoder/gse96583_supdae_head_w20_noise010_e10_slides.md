...
- SupDAE-32-head-w2.0-noise0.10 improves test macro-F1 over PCA-50 by +0.017.
- Test accuracy delta: `+0.011`
- PCA-50 test metrics: accuracy `0.922`, macro-F1 `0.850`, balanced accuracy `0.894`
- SupDAE-32-head-w2.0-noise0.10 test metrics: accuracy `0.933`, macro-F1 `0.867`, balanced accuracy `0.835`
- Validation/test macro-F1 stability:
| representation | val | test | val_test_gap |
| --- | ---: | ---: | ---: |
| PCA-50 | 0.850 | 0.850 | 0.000 |
| SupDAE-32-head-w2.0-noise0.10 | 0.866 | 0.867 | 0.001 |


## Slide 4: Class-level story

- Biggest gains: Dendritic cells (+0.049); FCGR3A+ Monocytes (+0.048); B cells (+0.016)
- Biggest drops: CD8 T cells (-0.006)
- Use the matching per-class delta figure for this run.

## Slide 5: Training story

- Best validation total loss: `0.5019`
- Final restored checkpoint validation total loss: `0.6606`
